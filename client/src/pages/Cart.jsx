...
const Cart = () => {
  ...
  const calculateTotal = () => {
    return cart.products.reduce((total, product) => {
      return total + product.price * quantities[product._id];
    }, 0);
  };
      ...
      <Wrapper>
        ...
        <Bottom>
              ...
              <Product key={product._id}>
                <ProductDetail>
                  ...
                  <Details>
                    ...
                    <Button onClick={() => handleRemoveClick(product._id)}>REMOVE</Button>
                  </Details>
                </ProductDetail>
                <PriceDetail>
                  <ProductAmountContainer>
                    <Add onClick={() => handleQuantity("inc", product._id)} />
                    <ProductAmount>{quantities[product._id]}</ProductAmount>
          ...
          <Summary>
            ...
            <StripeCheckout
              name="MY KART"
              image="https://aiconica.net/previews/shopping-cart-small-icon-423.png"
              billingAddress
              shippingAddress
